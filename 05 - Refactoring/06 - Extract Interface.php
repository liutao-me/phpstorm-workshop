...
// 1. Extract an interface from the CustomerRepository using Refactor This.
...
//    Checking the "Replace Class references with interfaces if possible" will update the CustomerController class.
//
